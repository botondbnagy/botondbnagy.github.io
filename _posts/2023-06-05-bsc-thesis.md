...
layout: post
---
# Evolution of Artificial Life: Investigating Optimisation in Gene Space (BSc Thesis, Distinction)
I carried out my BSc thesis under the supervision of [Dave Clements](https://www.imperial.ac.uk/people/d.clements) in the [Astrophysics Group](https://www.imperial.ac.uk/astrophysics) at Imperial College London. The project was titled *Evolution of Artificial Life: Investigating Optimisation in Gene Space*, and my partner Thushanan and I developed a numerical agent-based (python) simulation to investigate the optimisation problem of evolution.

The viva slides can be found [here](assets/bsc_viva.pdf) and the report [here](assets/bsc_thesis_report.pdf).
